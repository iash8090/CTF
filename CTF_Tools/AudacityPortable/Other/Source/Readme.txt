...
user in an INI file next to AudacityPortable.exe called AudacityPortable.ini.
...
copy AppNamePortable.ini from this directory to AudacityPortable.ini next to
AudacityPortable.exe. The options in the INI file are as follows:
